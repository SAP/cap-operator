...
[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=cap-operator&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=cap-operator)
