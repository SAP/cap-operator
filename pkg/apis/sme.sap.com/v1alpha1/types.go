...
type SubscriptionProviderSpec struct {
	...
	// List of subscription dependencies discovered for the services specified in the corresponding app
...
type SubscriptionSpec struct {
	...
	TenantId string `json:"tenantId"`
	// Subdomain of the consumer subaccount subscribing to the app
	Subdomain string `json:"subdomain"`
	// SubscriptionGuid of the subscription
	SubscriptionGuid string `json:"subscriptionGuid"`
	// Subscrption domain of the consumer subaccount subscribing to the app
...
// +kubebuilder:validation:Enum="";Ready;ProcessingError;Error;Processing;Deleting
type SubscriptionState string

const (
	SubscriptionStateProcessing      SubscriptionState = "Processing"
	SubscriptionStateProcessingError SubscriptionState = "ProcessingError"
