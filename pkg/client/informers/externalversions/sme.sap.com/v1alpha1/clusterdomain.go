...
type ClusterDomainInformer interface {
	...
	Lister() v1alpha1.ClusterDomainLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.SmeV1alpha1().ClusterDomains(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.SmeV1alpha1().ClusterDomains(namespace).Watch(context.TODO(), options)
			},
		},
		&smesapcomv1alpha1.ClusterDomain{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *clusterDomainInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&smesapcomv1alpha1.ClusterDomain{}, f.defaultInformer)
}

func (f *clusterDomainInformer) Lister() v1alpha1.ClusterDomainLister {
	return v1alpha1.NewClusterDomainLister(f.Informer().GetIndexer())
}
