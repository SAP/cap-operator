...
func (b *CAPTenantOperationApplyConfiguration) GetKind() *string {
	return b.TypeMetaApplyConfiguration.Kind
}

// GetAPIVersion retrieves the value of the APIVersion field in the declarative configuration.
func (b *CAPTenantOperationApplyConfiguration) GetAPIVersion() *string {
...
func (b *CAPTenantOperationApplyConfiguration) GetNamespace() *string {
	b.ensureObjectMetaApplyConfigurationExists()
