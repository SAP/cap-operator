...
type DomainInterface interface {
	...
	Apply(ctx context.Context, domain *smesapcomv1alpha1.DomainApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Domain, err error)
	// Add a +genclient:noStatus comment above the type to avoid generating ApplyStatus().
	ApplyStatus(ctx context.Context, domain *smesapcomv1alpha1.DomainApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha1.Domain, err error)
	DomainExpansion
}

// domains implements DomainInterface
type domains struct {
	*gentype.ClientWithListAndApply[*v1alpha1.Domain, *v1alpha1.DomainList, *smesapcomv1alpha1.DomainApplyConfiguration]
}

// newDomains returns a Domains
func newDomains(c *SmeV1alpha1Client, namespace string) *domains {
	return &domains{
		gentype.NewClientWithListAndApply[*v1alpha1.Domain, *v1alpha1.DomainList, *smesapcomv1alpha1.DomainApplyConfiguration](
			"domains",
			c.RESTClient(),
