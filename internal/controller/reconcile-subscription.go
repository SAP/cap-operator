...
func (c *Controller) createSubscriptionTenant(ctx context.Context, sub *v1alpha1.Subscription, ca *v1alpha1.CAPApplication) (*v1alpha1.CAPTenant, error) {
	...
	// OwnerRef to CAP Application, but w/o controller flag.
	applicationOwnerRef := *metav1.NewControllerRef(ca, v1alpha1.SchemeGroupVersion.WithKind(v1alpha1.CAPApplicationKind))
	applicationOwnerRef.Controller = ptr.To(false)
