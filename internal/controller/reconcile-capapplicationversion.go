...
func newPodDisruptionBudget(ca *v1alpha1.CAPApplication, cav *v1alpha1.CAPApplicationVersion, workload *v1alpha1.WorkloadDetails, workloadDeployment *appsv1.Deployment) *policyv1.PodDisruptionBudget {
	labels := copyMaps(workload.Labels, getLabels(ca, cav, CategoryWorkload, string(workload.DeploymentDefinition.Type), workload.Name, true))
	...
	return &policyv1.PodDisruptionBudget{
		...
		Spec: getPodDisruptionBudgetSpec(workload, labels),
	}
}

func getPodDisruptionBudgetSpec(workload *v1alpha1.WorkloadDetails, labels map[string]string) policyv1.PodDisruptionBudgetSpec {
