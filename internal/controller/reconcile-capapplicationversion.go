		...
		Spec: batchv1.JobSpec{
			...
			Template: corev1.PodTemplateSpec{
				...
				Spec: corev1.PodSpec{
					...
					TerminationGracePeriodSeconds: workload.JobDefinition.TerminationGracePeriodSeconds,
				},
			},
		},
	}
		...
		Spec: appsv1.DeploymentSpec{
			...
			Template: corev1.PodTemplateSpec{
				...
				Spec: corev1.PodSpec{
					...
					TopologySpreadConstraints:     getTopologySpreadConstraints(params.WorkloadDetails.DeploymentDefinition.TopologySpreadConstraints, labels, true),
					...
					TerminationGracePeriodSeconds: params.WorkloadDetails.DeploymentDefinition.TerminationGracePeriodSeconds,
				},
			},
		},
	}
...
func getContainer(params *DeploymentParameters) []corev1.Container {
	container := corev1.Container{
		...
		Lifecycle:       params.WorkloadDetails.DeploymentDefinition.Lifecycle,
	}
