...
{{% cardpane %}}
  {{% card header="Q4 2024" %}}
  CAP Operator now emits prometheus metrics for [Controller](../concepts/operator-components/controller/) and [Subscription Server](../concepts/operator-components/subscription-server/) components. Learn more about [metrics](../usage/operator-metrics).
  {{% /card %}}
  {{% card header="Q3 2024" %}}
